  ...
  perSystem =
    ...
    let
      ...
      maintenance = maintenanceLib.mkMaintenance {
        name = "maintenance";
        description = "Phenix host configuration maintenance";
        ci.github = {
          enable = true;
        ...
        commands = {
          ...
          test = {
            description = "Build complete host system compositions";
            order = [
              "laptop"
              "desktop"
            ];
            commands = {
              laptop = {
                ...
                exec = ''
                  ...
                  nix build --no-link --print-build-logs \
                    .#nixosConfigurations.matthisk-laptop-phenix.config.system.build.toplevel
                '';
              };
              ...
              desktop = {
                ...
                exec = ''
                  ${repositoryRoot}
                  nix build --no-link --print-build-logs \
                    .#nixosConfigurations.matthisk-desktop-phenix.config.system.build.toplevel
                '';
              };
            };
          };
